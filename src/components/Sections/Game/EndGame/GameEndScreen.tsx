            ...
            {isVisible && (
                <motion.div
                    ...
                    <motion.div
                        ...
                        <h2 className="text-2xl font-bold text-center text-white mb-6">Partie terminée !</h2>
                        ...
                        <div className="text-center">
                            ...
                            <motion.p className="text-white text-sm" initial={{opacity: 0}} animate={{opacity: 1}} transition={{delay: 0.7}}>
