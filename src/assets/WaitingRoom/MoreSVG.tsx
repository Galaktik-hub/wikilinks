...
const MoreSVG: React.FC<React.SVGProps<SVGSVGElement>> = props => {
    return (
        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <defs>
                <filter id="filter0_d_386_348" x="-4" y="0" width="33" height="33" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_386_348" />
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_386_348" result="shape" />
                </filter>
            </defs>
        </svg>
    );
